        ...
        <div className="bg-white dark:bg-[#0f172a] border border-gray-150 dark:border-gray-800 rounded-enterprise shadow-soft overflow-hidden">
          ...
          <div className="overflow-x-auto relative">
            <table className="w-full text-xs text-left min-w-[900px] table-auto">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-150 dark:border-gray-800 text-left">
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-gray-800/50">
                {loading ? (
                  ...
                  /* Empty State */
                  <tr>
                    <td colSpan={9} className="px-5 py-12 text-center text-gray-400 dark:text-gray-550 font-bold uppercase tracking-wider">
          ...
          {!loading && filteredOrders.length > 0 && (
            <div className="flex justify-between items-center px-5 py-3.5 border-t border-gray-150 dark:border-gray-800">
              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                Showing {startIndex + 1} - {Math.min(endIndex, filteredOrders.length)} of {filteredOrders.length} records
              </span>
              <div className="flex items-center gap-1">
                <button
                  disabled={currentPage === 1}
                  onClick={() => setCurrentPage(prev => Math.max(1, prev - 1))}
                  className="p-1 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-500 disabled:opacity-50 transition-colors"
                >
                  ...
                  <tbody className="divide-y divide-gray-50 dark:divide-gray-800/40">
                    {history.map((h) => (
                      <tr key={h.id} className="hover:bg-gray-55/40 dark:hover:bg-gray-800/10 transition-colors">
                        <td className="px-4 py-3 font-semibold text-gray-400 dark:text-gray-500 whitespace-nowrap">{h.date}</td>
